...
```
fetchv2_fetch_llms_txt({ url: "https://sdk.vercel.ai/llms.txt" })
```
...
```
fetchv2_fetch({ url: "https://sdk.vercel.ai/docs/ai-sdk-core/generating-text", max_length: 5000 })
```

For multiple pages at once:
```
fetchv2_fetch_batch({ urls: ["https://sdk.vercel.ai/docs/ai-sdk-core/settings", "https://sdk.vercel.ai/providers/ai-sdk-providers/amazon-bedrock"], max_length_per_url: 2000 })
```
