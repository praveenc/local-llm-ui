...
const GenAiLabel = () => (
  <Box variant="awsui-gen-ai-label" fontSize="body-s" color="text-body-secondary">
...
const MessageList = ({
  ...
  // Find the first assistant message index for "Generated by AI" label
    ...
    <SpaceBetween size="s">
      {messages.map((message, index) => (
        <SpaceBetween key={message.id} size="xs">
          ...
          {/* Show "Generated by AI" label on first assistant message */}
